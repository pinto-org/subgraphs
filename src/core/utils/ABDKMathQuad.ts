...
export function ABDK_toUInt(x: BigInt): BigInt {
  ...
  let exponent = x
    .rightShift(112)
    .bitAnd(BigInt.fromUnsignedBytes(Bytes.fromUint8Array(Bytes.fromHexString("0x7FFF").reverse())));
  ...
  let result = x
    .bitAnd(BigInt_bigEndian("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFF"))
    .bitOr(BigInt_bigEndian("0x010000000000000000000000000000"));
