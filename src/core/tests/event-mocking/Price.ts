...
class Pool {
  ...
  price: BigInt;
  liquidity: BigInt;
  beanLiquidity: BigInt;
  nonBeanLiquidity: BigInt;
  deltaB: BigInt;
  lpUsd: BigInt;
  lpBdv: BigInt;
}
...
export function setMockBeanPrice(
  ...
  createMockedFunction(
    contract,
    "price",
    "price():((uint256,uint256,int256,(address,address[2],uint256[2],uint256,uint256,uint256,uint256,int256,uint256,uint256)[]))"
    ...
    ps: [
      {
        ...
        beanLiquidity: BigInt.fromString("5"),
        nonBeanLiquidity: BigInt.fromString("5"),
...
function toPoolStruct(pool: Pool): ethereum.Tuple {
  ...
  retval.push(ethereum.Value.fromUnsignedBigInt(pool.beanLiquidity));
  retval.push(ethereum.Value.fromUnsignedBigInt(pool.nonBeanLiquidity));
