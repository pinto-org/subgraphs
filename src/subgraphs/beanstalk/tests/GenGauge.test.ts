...
describe("Gen Gauge", () => {
  ...
  describe("Convert up bonus", () => {
    test("Assigns initial value/data", () => {
      ...
      assert.fieldEquals("GaugesInfo", "gauges", "g2BdvConvertedThisSeason", "6");
      assert.fieldEquals("GaugesInfo", "gauges", "g2MaxTwaDeltaB", "8");
    });
    ...
    test("Updates data", () => {
      ...
      const data = Bytes.fromHexString(
        ""
      );
