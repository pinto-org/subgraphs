      ...
      ps: [
        {
          ...
          beanLiquidity: curveLiquidity.div(BigInt.fromString("2")),
          nonBeanLiquidity: curveLiquidity.div(BigInt.fromString("2")),
          deltaB: curveDelta,
        ...
        },
        {
          ...
          beanLiquidity: beanEthLiquidity.div(BigInt.fromString("2")),
          nonBeanLiquidity: beanEthLiquidity.div(BigInt.fromString("2")),
          deltaB: beanEthDelta,
          lpUsd: BigInt.fromString("10"),
          lpBdv: BigInt.fromString("10")
        }
