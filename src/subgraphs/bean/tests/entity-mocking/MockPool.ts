...
import { mockPreReplantBeanEthPriceAndLiquidity } from "../../../../core/tests/event-mocking/Price";
import { BEAN_WETH_V1, BEANSTALK_BLOCK } from "../../../../core/constants/raw/BeanstalkEthConstants";
import { loadOrCreatePool } from "../../src/entities/Pool";

export function mockPoolPriceAndLiquidity(
  poolAddr: Address,
  price: BigDecimal,
